#include "AliJMultiplicityMeanPtAnalysis.h"
#include <TFile.h>
#include <TDirectory.h>
#include <TMath.h>
#include <iostream>

ClassImp(AliJMultiplicityMeanPtAnalysis);

AliJMultiplicityMeanPtAnalysis::AliJMultiplicityMeanPtAnalysis(const char* name) : 
    fName(name)
{
...
AliJMultiplicityMeanPtAnalysis::~AliJMultiplicityMeanPtAnalysis() {
...
void AliJMultiplicityMeanPtAnalysis::InitializeMaps() {
...
void AliJMultiplicityMeanPtAnalysis::SetSystemParameters(const char* collisionSystem) {
...
void AliJMultiplicityMeanPtAnalysis::SetCentralityBins(const std::vector<double>& centBins) {
    fCentBins = centBins;
    InitializeMaps();
}

int AliJMultiplicityMeanPtAnalysis::GetCentBin(double centrality) {
...
void AliJMultiplicityMeanPtAnalysis::ProcessEvent(double centrality, const std::vector<double>& pt_values, 
...
void AliJMultiplicityMeanPtAnalysis::FinalizeMeasurements() {
    int nCentBins = fCentBins.size() - 1;
...
TGraphErrors* AliJMultiplicityMeanPtAnalysis::GetMultGraph(const char* particle) {
...
TGraphErrors* AliJMultiplicityMeanPtAnalysis::GetMultRapGraph(const char* particle) {
    std::string key(particle);
...
TGraphErrors* AliJMultiplicityMeanPtAnalysis::GetMeanPtGraph(const char* particle) {
    std::string key(particle);
...
void AliJMultiplicityMeanPtAnalysis::WriteGraphs(TObject* dir) {
