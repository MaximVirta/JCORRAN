#ifndef ALIJMULTIPLICITYMEANPTANALYSIS_H
#define ALIJMULTIPLICITYMEANPTANALYSIS_H
...
class AliJMultiplicityMeanPtAnalysis : public TObject {
public:
    AliJMultiplicityMeanPtAnalysis(const char* name = "MultiplcityMeanPtAnalysis");
    virtual ~AliJMultiplicityMeanPtAnalysis();
...
private:
    ...
    ClassDef(AliJMultiplicityMeanPtAnalysis, 1);
};
